...
IDENTIFIED BY 'super_secret-pswd_911'
...
REVOKE ALL, GRANT OPTIONS FROM 'brt_user'@'localhost';
...
DROP USER
IF EXISTS 'admin_007'0'%';

SELECT 'ADDING USER admin_007' AS'INSTALLATION PROGRESSING';
CREATE USER
IF NOT EXISTS 'admin_007'0'%'
IDENTIFIED BY 'guttmanGrizzlies_2024'
FAILED_LOGIN_ATTEMPTS 4
PASSWORD_LOCK_TIME UNBOUNDED
PASSWORD EXPIRE INTERVAL 90 DAY
PASSWORD HISTORY 5
PASSWOORD REUSE INTERVAL 365 DAY;
